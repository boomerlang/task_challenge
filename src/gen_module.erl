...
%%
%% Generates a dynamic module with a random name
%% that contains the tasks as a recursive call tree
%%
%% The generated module has the following structure (from the input example):
%%-module(fsdfsdfsdkf_0_1234_0).
%%-export([sort_tasks/0]).
%% sort_tasks() -> 'task-4'([]).
